...
public class ShortLinkServiceImpl extends ServiceImpl<ShortLinkMapper, ShortLinkDO> implements ShortLinkService {
    ...
    public void updateShortLink(ShortLinkUpdateReqDTO requestParam) {
        ...
        if (Objects.equals(existedShortLinkDO.getGid(), requestParam.getGid())) {
            ...
            ShortLinkDO shortLinkDO = ShortLinkDO.builder()
                    ...
                    .favicon(Objects.equals(requestParam.getOriginUrl(), existedShortLinkDO.getOriginUrl()) ? existedShortLinkDO.getFavicon() : getFavicon(requestParam.getOriginUrl()))
    ...
    public void restoreUrl(String shortUri, ServletRequest request, ServletResponse response) {
        ...
        try {
            ...
            gotoNullShortLink = stringRedisTemplate.opsForValue().get(String.format(GOTO_NULL_SHORT_LINK_KEY, fullShortUrl));
            if (StrUtil.isNotBlank(gotoNullShortLink)) {
                ((HttpServletResponse) response).sendRedirect("/page/notfound");
                return;
            }
